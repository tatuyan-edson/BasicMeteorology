...
\section{問題}
    ...
    \item 次の文章を読んで、後の問いに答えなさい。%断熱減率と大気の安定性について記述する。
        \begin{screen}
          ...
          乾燥空気での(A),(B),(C)については、$_{(\mathrm{c})}$\underline{周囲の気層の気温減率と気塊の(E)の大小関係により与えられる。}
          一方、湿潤空気については、一義的には仮温度を用いて同様の議論を行えば良い他、$_{(\mathrm{d})}$\underline{その飽和度に応じて(E)と(F)を使い分けることでも同様の関係を導ける。}
